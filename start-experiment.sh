...
loadDataToDatabaseFromExternFolder() {
  sshpass -p $1 ssh cs4224j@xcnc20.comp.nus.edu.sg "source .bash_profile; cd temp/cockroachdb && mvn clean dependency:copy-dependencies package; java -Xms45g -Xmx45g -cp target/*:target/dependency/*:. InitialiseData"
